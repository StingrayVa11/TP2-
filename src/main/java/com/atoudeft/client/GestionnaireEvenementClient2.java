...
//                    break;
                ...
                case "EPARGNE" :
                    ...
                    /**
                     * Tristan G
                     * 2.3.A Afficher un message d’erreur dans une boîte de message, si
                     * l’opération échoue;
                     */
                    if (arg.trim().startsWith("NO")) {
                        JOptionPane.showMessageDialog(panneauPrincipal,"Echec de la création du compte épargne");
                    }
                    /**
                     * Tristan G
                     * 2.3.B Ajouter le numéro de compte à la liste des numéros (dans le JList).
                     */
                    else{
                        /*
                         * Petite différence entre comment nouve+connecte renvoie les comptes par rapport
                         * a comment cheque et epargne le renvoie. Le prof nous prienviendras si c'est
                         * un problème à changer dans serveur.
                         */
                ...
                case "SELECT" :
                    arg = evenement.getArgument();
                    String[] solde1 = arg.split(" ");
                    panneauPrincipal.afficherSolde("Solde: "+solde1[2]);
