    ...
    public void seMettreAJour(Observable observable) {
        if (observable instanceof Client) {
            ...
            if (!client.isConnecte()) {
                ...
                miDeconnecter.setEnabled(false); // désactiver le bouton déconnection si l'utilisateur n'est pas connecté
                miConnecter.setEnabled(true); // activer le bouton connection si l'utilisateur n'est pas connecté
            } else {
                miDeconnecter.setEnabled(true); // activer le bouton déconnection si l'utilisateur est connecté
                miConnecter.setEnabled(false); // désactiver le bouton connection si l'utilisateur est connecté
            }
        }
    }
}